...
def plagiarismCheck(code1, code2, language):
    # Tokenize the code strings using the specified language
    token1 = tokenize(code1, language)
    str1 = toText(token1)
    token2 = tokenize(code2, language)
    str2 = toText(token2)
